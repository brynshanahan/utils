...
},{}],"reactive/reactive.ts":[function(require,module,exports) {
"use strict";
...
function reactive(initialState) {
  ...
  var target = new Proxy(function () {}, {
    ...
    apply: function apply(target, self, args) {
      ...
      return subject.on.apply(subject, args);
    }
  });
  return target;
}
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","reactive/reactive.ts"], null)
//# sourceMappingURL=/reactive/reactive.js.map