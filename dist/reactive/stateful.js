...
function () {
  ...
  Subject.prototype.on = function (nameOrCallback, fn) {
    ...
    for (var _i = 0, eventNames_1 = eventNames; _i < eventNames_1.length; _i++) {
      var eventName = eventNames_1[_i]; // If this is the first listener of type eventName then listeners[eventName] will be empty
  ...
  Subject.prototype.emit = function (name) {
    ...
    if (name !== subject) {
      // @ts-ignore
      this.emit.apply(this, __spreadArrays([subject], args));
  ...
  Subject.prototype.reduce = function (name) {
    ...
    if (this[subject].listeners[name]) {
      return this.getHandlers(name).reduce(function (memo, fn) {
        var v = fn.apply(void 0, __spreadArrays([memo], rest));
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (this[subject].listeners[name]) {
          return [2
          /*return*/
          , Object.values(this[subject].listeners[name]).reduce(function (last, fn) {
            var v = fn.apply(void 0, __spreadArrays([last], rest));
...
exports.allChanges = 'all_changes' + Math.random().toFixed(4);
...
function (_super) {
  ...
  Stateful.prototype.setState = function (stateOrFn) {
    var _this = this; // You can pass a function that returns state or a plain object
    ...
    this.emit(exports.allChanges, update); // Emit events for all the keys in changedKeys

    for (var _i = 0, changedKeys_1 = changedKeys; _i < changedKeys_1.length; _i++) {
      var key = changedKeys_1[_i];
    ...
    this.hasChanged = __spreadArrays(this.hasChanged, changedKeys.filter(function (x) {
      return !_this.hasChanged.includes(x);
    }));
  };
  ...
  Stateful.prototype.changed = function () {
    ...
    if (args.length === 2) {
      ...
      return this.on(exports.allChanges, args[0]);
    }
  }; // Alias for this.changed(() => {})


  Stateful.prototype.listen = function (fn) {
    return this.on(exports.allChanges, fn);
  };
...
function clone(objs) {
  ...
  return Object.assign.apply(Object, __spreadArrays([{}, objs], rest));
}
