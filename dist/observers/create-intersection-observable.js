...
},{}],"observers/create-intersection-observable.ts":[function(require,module,exports) {
"use strict";
...
var CustomIntersectionObserverEntry =
/** @class */
function () {
...
function createIntersectionObservable(root, opts) {
  if (root === void 0) {
    root = window;
  }
    ...
    function getSource() {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!!window.IntersectionObserver) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
              , Promise.resolve().then(function () {
                return __importStar(require('intersection-observer'));
              })];
...
},{"../reactive/observable":"reactive/observable.ts","intersection-observer":"../node_modules/intersection-observer/intersection-observer.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
