...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"element/is.ts":[function(require,module,exports) {
"use strict";
...
exports.is = is;
},{}],"element/temp-node.ts":[function(require,module,exports) {
"use strict";
...
var TempNode = /*#__PURE__*/function () {
  function TempNode(element) {
    ...
    this.nodeList = new Set(_toConsumableArray(element.children));
    ...
    value: function querySelectorAll(query) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          children.push.apply(children, _toConsumableArray(child.querySelectorAll(query)));
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
    ...
    get: function get() {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          result += _is.is.element(child) ? child.innerHTML : child.textContent;
        }
      } catch (err) {
        _iterator4.e(err);
      } finally {
...
},{"./is":"element/is.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","element/temp-node.ts"], null)
//# sourceMappingURL=/element/temp-node.js.map