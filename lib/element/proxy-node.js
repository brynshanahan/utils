...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"element/proxy-node.ts":[function(require,module,exports) {
      ...
      try {
        for (var _iterator2 = actions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (action.get) {
            ...
            var _action$apply = _slicedToArray(action.apply, 1),
    ...
    var prox = new Proxy(obj, {
      get: function get(target, prop) {
        ...
        if (_typeof(val) === 'object' || typeof val === 'function') {
          return createProxy(val, [].concat(_toConsumableArray(actions), [{
            get: prop
          }]));
        }
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","element/proxy-node.ts"], null)
//# sourceMappingURL=/element/proxy-node.js.map